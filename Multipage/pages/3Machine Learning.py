...
st.subheader("Halaman Machine Learning")
st.write(
            """
            Di dalam Halaman Machine Learning akan mempelajari bagaimana caranya Upload file dan Membaca File dengan _type CSV_.
